...
const fr: TranslationShape = {
  ...
  about: {
    ...
    name: "Nataniel Oliveira",
    paragraph1:
      "Je suis un développeur Fullstack passionné par la technologie et l'innovation. J'ai consacré ma carrière à créer des solutions numériques qui font la différence dans la vie des gens.",
    paragraph2:
  ...
  projects: {
    ...
    pizzaria: {
      title: "PizzaExpress",
      description:
        "Système de gestion de commandes pour une pizzeria : tables, cuisine et panneau admin. Backend non publié — inclut une démo interactive.",
    },
  },
};
